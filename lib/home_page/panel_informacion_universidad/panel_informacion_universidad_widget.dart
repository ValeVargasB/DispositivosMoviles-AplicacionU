...
class PanelInformacionUniversidadWidget extends StatefulWidget {
  ...
  @override
  State<PanelInformacionUniversidadWidget> createState() =>
      _PanelInformacionUniversidadWidgetState();
}

class _PanelInformacionUniversidadWidgetState
    extends State<PanelInformacionUniversidadWidget> {
  late PanelInformacionUniversidadModel _model;
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0xFF1E4ED8), Color(0xFF5B3DF5)],
                  stops: [0.0, 1.0],
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Institución de educación superior comprometida con la formación integral de profesionales.',
